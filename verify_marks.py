...
def verify_marks_consistency():
    ...
    backend_url = "http://192.168.18.139:8000/api/test-marks/"
    ...
    try:
        ...
        print("❌ Cannot connect to backend server. Make sure it's running on http://192.168.18.139:8000")
...
def check_admin_data():
    ...
    try:
        ...
        response = requests.get("http://192.168.18.139:8000/api/monthly-tests/")
        if response.status_code == 200:
            tests = response.json()
